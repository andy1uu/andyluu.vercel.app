...
const NavBarLink = ({
  ...
  return (
    <a
      ...
      aria-label={label}
      color="default"
      className={`group bg-background hover:text-accent relative flex justify-start gap-2 rounded-full p-3 shadow-md transition-all ${pathname === link && "text-primary"}`}>
      {icon}
